        ...
        <div className=''>
            ...
            >
                ...
                <div className='px-4 md:px-48'>
                    ...
                    <div className='flex justify-center gap-x-32 mt-12'>
            ...
            >
                <p className='text-center text-5xl font-semibold pt-[250px]'>Send money with Pay<span className='text-[#FF6A2B]'>va</span> in </p>
            ...
            >
                <div className='flex justify-center items-center gap-x-16 pt-[230px]'>
                    <div>
                        ...
                        <p className='max-w-[370px] text-lg mt-4'>Move your money across borders in seconds. With our secure, low-cost transfers, you can send and recieve funds instantly.
                        </p>

                        <button className='bg-[#FF6A2B] rounded-xl py-4 px-4 text-white text-xl flex items-center gap-x-2 mt-9'>Sign Up for free<HiOutlineArrowNarrowRight color='white' size={24} /> </button>
            ...
            <div
                ...
                style={{ backgroundImage: `url(${hero3})` }}
            >
                <p className='text-center text-5xl font-semibold pt-[250px]'>The Pay<span className='text-[#FF6A2B]'>va</span> Advantage: Secure, Fast and Flexible </p>
...
<div className='flex justify-end px-32'>
    ...
    <div>
                ...
                <p className='text-center text-5xl font-semibold pt-[150px]'>Pay<span className='text-[#FF6A2B]'>va</span> is available in Canada and Nigeria</p>
...
<div className='flex justify-center items-center gap-x-24 mt-24'>
